...
while($row = $checked->fetch_assoc()):
    ?>
    <tr>
        <td class="text-center"><?php echo $i++ ?></td><td class="text-center">
    <?php 
    if (isset($room_arr[$row['room_id']]['category_id']) && isset($cat_arr[$room_arr[$row['room_id']]['category_id']]['name'])) {
    ...
    ?>
        ...
        <td class=""><?php echo isset($room_arr[$row['room_id']]['room']) ? $room_arr[$row['room_id']]['room'] : ''; ?></td>
        <td class=""><?php echo isset($row['ref_no']) ? $row['ref_no'] : ''; ?></td>
        <?php if($row['status'] == 1): ?>
