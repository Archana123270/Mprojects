            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="start.html">Home</a></li>
    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">DREAM DESTINATION GATEWAY</div></div>
        </footer>
