...
if (isset($_POST["submit"])) {
   ...
   $query = "INSERT INTO `signup`(`id`, `username`,`email`, `password`) VALUES (NULL,'$username','$email','$password')";
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="password" class="form-control" name="password" placeholder="p*****d">
            </div>
